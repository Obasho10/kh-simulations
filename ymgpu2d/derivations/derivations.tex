...
\begin{intuition}
A self-limiting resonance. The beam response is a Lorentzian in the
...
band of precession frequencies it averages over, and the weaker the peak
drive $G_{\max}=\alpha\Vo^2/\gamma$ it can extract. The ceiling
...
a surface-mode-like state. This marginality explains two robust
