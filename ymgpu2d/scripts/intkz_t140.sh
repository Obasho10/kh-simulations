...
run_tag = recorr
EOINI
echo "[t140] a=4.5 V0=0.2 kz=2.0 (tier=int k=2 sp=8.0 tu=100.0) start $(date)" >> $LOG
(cd $WDIR/outputs && $WDIR/ym_coupled /tmp/recorr_t140_a4.5_v0.2_kz2.0.ini >> $LOG 2>&1) || echo "[t140] a=4.5 V0=0.2 kz=2.0 CRASHED (exit $?) $(date)" >> $LOG
...
run_tag = recorr
EOINI
echo "[t140] a=5.5 V0=0.2 kz=2.0 (tier=int k=2 sp=8.0 tu=100.0) start $(date)" >> $LOG
(cd $WDIR/outputs && $WDIR/ym_coupled /tmp/recorr_t140_a5.5_v0.2_kz2.0.ini >> $LOG 2>&1) || echo "[t140] a=5.5 V0=0.2 kz=2.0 CRASHED (exit $?) $(date)" >> $LOG
...
run_tag = recorr
EOINI
echo "[t140] a=6.0 V0=0.2 kz=8.0 (tier=int k=8 sp=8.0 tu=100.0) start $(date)" >> $LOG
...
run_tag = recorr
EOINI
echo "[t140] a=0.3 V0=0.07 kz=2.0 (tier=int k=2 sp=14.0 tu=267.4) start $(date)" >> $LOG
(cd $WDIR/outputs && $WDIR/ym_coupled /tmp/recorr_t140_a0.3_v0.07_kz2.0.ini >> $LOG 2>&1) || echo "[t140] a=0.3 V0=0.07 kz=2.0 CRASHED (exit $?) $(date)" >> $LOG
(cd $WDIR/outputs && python3 ../analysis/remote_timeseries.py "ym_k2_a0.300_*_v0.0700_*_recorr" >> $LOG 2>&1)
echo "[t140] a=0.3 V0=0.07 kz=2.0 done $(date)" >> $LOG

cat > /tmp/recorr_t140_a0.7_v0.04_kz7.0.ini <<'EOINI'
k_mode = 7
alpha_YM = 0.7
V0 = 0.04
perturb_amp = 0.001
...
run_tag = recorr
EOINI
echo "[t140] a=0.7 V0=0.04 kz=7.0 (tier=int k=7 sp=8.0 tu=283.5) start $(date)" >> $LOG
(cd $WDIR/outputs && $WDIR/ym_coupled /tmp/recorr_t140_a0.7_v0.04_kz7.0.ini >> $LOG 2>&1) || echo "[t140] a=0.7 V0=0.04 kz=7.0 CRASHED (exit $?) $(date)" >> $LOG
...
run_tag = recorr
EOINI
echo "[t140] a=0.5 V0=0.03 kz=8.0 (tier=int k=8 sp=8.0 tu=400.0) start $(date)" >> $LOG
(cd $WDIR/outputs && $WDIR/ym_coupled /tmp/recorr_t140_a0.5_v0.03_kz8.0.ini >> $LOG 2>&1) || echo "[t140] a=0.5 V0=0.03 kz=8.0 CRASHED (exit $?) $(date)" >> $LOG
...
run_tag = recorr
EOINI
echo "[t140] a=0.3 V0=0.07 kz=5.0 (tier=int k=5 sp=10.0 tu=400.0) start $(date)" >> $LOG
(cd $WDIR/outputs && $WDIR/ym_coupled /tmp/recorr_t140_a0.3_v0.07_kz5.0.ini >> $LOG 2>&1) || echo "[t140] a=0.3 V0=0.07 kz=5.0 CRASHED (exit $?) $(date)" >> $LOG
