...
for run_dir in sorted(glob.glob(pattern)):
    ...
    # (This exact fix -- and the matching main_ym.cu dir-tag -- was found
    # already deployed, uncommitted, on t126/t133/t140; rescued into git
    # alongside the same fix reconstructed independently, 2026-07-19.)
